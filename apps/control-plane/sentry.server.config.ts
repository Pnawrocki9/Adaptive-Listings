 ...
 * `docs/compliance/dpia.md` §2.7. Read that section before adding one.
 *
 ...
 * sentinel). If you add a hook, both fail — update §2.7 in the same PR.
 *
...
if (dsn) {
  Sentry.init({
     ...
     * without a diff in this file. (FOLLOW-811 / dpia.md §2.7.)
     */
