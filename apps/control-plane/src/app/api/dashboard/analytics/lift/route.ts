 ...
 * @estalara/auth is a workspace package not built locally; TypeScript sees its return type
 * as `any`. CI builds packages before lint so these errors don't appear in CI.
 * Same pattern as middleware.ts and other routes importing from @estalara/auth.
 */
/**
