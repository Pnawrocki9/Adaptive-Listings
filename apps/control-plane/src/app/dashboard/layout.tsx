 ...
 *   - Settings          /dashboard/settings    (FOLLOW-161 — global generation-model selector)
 *
...
const NAV_LINKS = [
  ...
  {
    href: '/dashboard/demo/override',
    label: 'Archetype Simulator',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
  ...
  {
    href: '/dashboard/analytics/labels',
  ...
  {
    // FOLLOW-161 — global generation-model selector. The page self-gates to
    // agency:admin / agency:owner; this link matches the layout's existing
    // ungated pattern, so non-admins who click it hit the page's own access control.
