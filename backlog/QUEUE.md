...
failing); FOLLOW-187 updated to Activity 15 (FOLLOW-230 fixed collision).** Carries forward all
READY Sprint 14 items not touched by Sprint 15, plus the Wave 2 deferred item from Sprint 15.
...
- **Track D (GDPR/compliance):** FOLLOW-184 (P1, Art.17 DSR gap), FOLLOW-185 (P1, PG harness),
  FOLLOW-187 (P1, ROPA Activity 15 + DPIA — READY, unblocked by FOLLOW-230)
...
- id: FOLLOW-187
  ...
  notes: |
    ...
    resolved). Delegate to compliance-engineer + data-engineer.
