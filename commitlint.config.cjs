      ...
      rules: {
        ...
        'ticket-reference': (parsed) => {
          ...
          if (!ticketPattern.test(subject)) {
            return [
              false,
              'Commit message must include [TICKET-XXX], [TICKET-FIX-XXX], [TICKET-INFRA-XXX], [TICKET-DEMO-XXX], [TICKET-ADM-XXX], [TICKET-QUIZ-XXX], [TICKET-DB-XXX], or [ESCALATION] reference. Example: feat(ingest): add validation [TICKET-042]',
            ];
          }
