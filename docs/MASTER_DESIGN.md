...
**Wersja:** 2.8 (Sprint 12 CLOSED — Lane A + Lane C shipped; Sprint 13 OPEN — three-track structure: correctness → pilot launch → intent v1.0; pilot onboarding TICKET-PILOT-001/002 moved Sprint 12 Lane B → Sprint 13 Lane B; RETRO-SPRINT-12 written; 4 tracking inconsistencies cleaned) | **Data:** 25 maja 2026 | **Autorzy odbiorcy:** Piotr Nawrocki (CEO), Rafał Palak PhD (CTO), Krystian Wojtkiewicz PhD (CPO)
