...
**Wersja:** 3.1 (Sprint 13a Lane A Wave 2 MERGED — FOLLOW-097 inquiry-selector SDK init + FOLLOW-106 pilot_frozen flag on main; Wave 3 unblocked; otherwise as v3.0) | **Data:** 26 maja 2026 | **Autorzy odbiorcy:** Piotr Nawrocki (CEO), Rafał Palak PhD (CTO), Krystian Wojtkiewicz PhD (CPO)
