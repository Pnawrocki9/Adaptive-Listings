...
**Wersja:** 3.6 (Adaptive Listings Remediation Plan v3 ratified by CEO 2026-05-30 — 31 tickets / 6 sprints / ~8 weeks; full plan in `backlog/PLAN-V3-2026-05-30.md`; APPROVED_TO_IMPLEMENT=false pending D-1, D-3, D-4, D-5, D-6 ratification and R-1…R-5 deliverables; otherwise as v3.5) | **Data:** 30 maja 2026 | **Autorzy odbiorcy:** Piotr Nawrocki (CEO), Rafał Palak PhD (CTO), Krystian Wojtkiewicz PhD (CPO)
