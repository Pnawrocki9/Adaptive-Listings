...
**Wersja:** 3.0 (Phase-0 specs RATIFIED by CEO; **APPROVED_TO_IMPLEMENT=true**; Sprint 13a Lane A → 6 tickets with FOLLOW-106 pilot_frozen flag; FOLLOW-107 Worker retirement Phase 2 → Sprint 14; ADR-0006 Worker disposition phased 3c→3a; FOLLOW-099 bot-UA AC; pilot trustworthiness gates locked) | **Data:** 25 maja 2026 | **Autorzy odbiorcy:** Piotr Nawrocki (CEO), Rafał Palak PhD (CTO), Krystian Wojtkiewicz PhD (CPO)
