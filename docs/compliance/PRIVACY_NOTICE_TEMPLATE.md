...
**Version:** 1.7 **Date:** 2026-08-07 **Author:** Compliance Engineering **Regulatory basis:** GDPR
...
> full three-store verification: `docs/compliance/C-07-chat-retention-scope.md` **v1.2** — read
