...
This directory contains Estalara's statutory compliance documentation. All documents are
append-only living artifacts (ADR-style): original text is not modified; changes are appended as
numbered revision sections.
...
- **UAE PDPL** (Federal Decree-Law 45/2021 + Cabinet Decision 111/2023) + DIFC Data Protection Law No. 5 of 2020
