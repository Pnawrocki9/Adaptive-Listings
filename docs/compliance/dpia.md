...
**Document ID:** ESTALARA-DPIA-001 **Version:** 2.5 **Date:** 2026-06-08 **Authors:** Time2Show,
...
| Engagement Score                               | Postgres: `engagement_scores`              | 90 days from last active event                                                        | LI — Time2Show as Sole Controller           |
...
| CRM outcome labels (`conversion_labels`)       | Postgres: `conversion_labels`              | 13 months from `labeled_at` — **policy only; not yet enforced** (FOLLOW-234 required) | LI (model calibration + AI Act audit trail) |
