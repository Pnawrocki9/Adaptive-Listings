...
**Document ID:** ESTALARA-DPIA-001 **Version:** 2.12 **Date:** 2026-08-05 **Authors:** Time2Show,
...
independent in this app.** `consoleIntegration()` is a **default** integration of the installed Node
SDK (`@sentry/node-core@10.50.0`, `build/cjs/sdk/index.js:41`). Every `console.error`/`console.warn`
in `apps/control-plane` — 115 and 33 non-test call sites respectively — is therefore also a Sentry
