...
#         contract. (A former Gate 2 asserted the Decision API Worker's /api/adapt
#         route stayed retired at 410 Gone — ADR-0004 §2 / ADR-0006 §Decision 3. The
#         Worker was deleted 2026-09-24 by FOLLOW-1262, so that gate had nothing left
#         to check and was removed with it.)
echo ""
